...
GmshWriter* GmshWriter::New(){
  return new GmshWriter;
}
...
int GmshWriter::GetBinaryWriteMode(){
  return this->isBinary;
    }

void GmshWriter::SetFileName(char* FileName){
  this->FileName.assign(FileName);
};

const char * GmshWriter::GetFileName(){
...
int GmshWriter::Write(vtkUnstructuredGrid *input)
{
  ...
  if (this->isBinary==1) {
    GMSHfile.open(this->FileName.c_str(),std::ofstream::binary);
  } else {
